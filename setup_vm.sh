...
echo "=== Setup complete ==="
echo ""
echo "To run the V4 ensemble pipeline:"
echo "  uv run python -m pipelines.v4_ensemble"
echo ""
echo "To run just Stage 1 sanity (fast):"
echo "  uv run python -c 'from pipelines.v4_ensemble import stage1_sanity; stage1_sanity()'"
echo ""
echo "See README.md for the full pipeline list."
